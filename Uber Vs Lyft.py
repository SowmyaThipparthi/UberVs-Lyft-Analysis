...
#Read both the file car_rides and weather
...
#Create a new column by combining location and date
...
data_w.index = data_w['location_date']  #data_w = Weather data


data_total = data_c.join(data_w, on= ['location_date'], rsuffix ='_w') # Join the car_ride and weather data # combine both car_ride and weather dataset using the join
data_total
...
group_id
#Create new slices of individual data
...
# Ride distributions (Lyft nad Uber) on a single day
